...
// sleeping the thread for 300 milli seconds
                Thread.sleep(300);
                System.out.println("This is running : " + Thread.currentThread().getName());
            }
...
// the first thread th1 has ended or died.
        try
        {
            System.out.println("The current thread name is a: "+ Thread.currentThread().getName());
...
// starting the th3 thread after when the thread th2 has ended or died.
        try
        {
            System.out.println("The current thread name is b: " + Thread.currentThread().getName());
            th2.join();
        }
